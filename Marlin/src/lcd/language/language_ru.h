...
namespace Language_ru {
  ...
  LSTR MSG_MEDIA_INSERTED                   = _UxGT("Флешка вставлена");
  LSTR MSG_MEDIA_REMOVED                    = _UxGT("Флешка извлечена");
  LSTR MSG_MEDIA_WAITING                    = _UxGT("Вставьте флешку");
  #if LCD_WIDTH > 21 || HAS_DWIN_E3V2
    LSTR MSG_MEDIA_INIT_FAIL                = _UxGT("Сбой чтения флешки");
  #else
    LSTR MSG_MEDIA_INIT_FAIL                = _UxGT("Сбой флешки");
  #endif
  ...
  LSTR MSG_MEDIA_MENU                       = _UxGT("Печать с флешки");
  LSTR MSG_NO_MEDIA                         = _UxGT("Нет флешки");
  ...
  LSTR MSG_ATTACH_MEDIA                     = _UxGT("Установить флешку");
  LSTR MSG_CHANGE_MEDIA                     = _UxGT("Сменить флешку");
  LSTR MSG_RELEASE_MEDIA                    = _UxGT("Извлечь флешку");
